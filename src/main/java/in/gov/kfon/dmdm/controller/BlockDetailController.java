...
public class BlockDetailController {
    ...
    public ResponseEntity<Response<List<CommonLookUp>>> fetchCorporationName(@PathVariable int districtId, @PathVariable int villageTypeId) {
    ...
    public ResponseEntity<Response<List<CommonLookUp>>> fetchPanchayatName(@PathVariable int districtId, @PathVariable int villageTypeId) {
    ...
    public ResponseEntity<Response<List<CommonLookUp>>> fetchBlockName(@PathVariable int districtId, @PathVariable int villageTypeId) {
