...
CREATE TABLE cor_otc_invoicing (
  ...
  CONSTRAINT pk_cor_otc_invoicing PRIMARY KEY (invoicing_id)
);
...
CREATE TABLE cor_otc_partnertransfer (
  ...
  CONSTRAINT pk_cor_otc_partnertransfer PRIMARY KEY (transfer_id)
);
...
CREATE TABLE cor_package (
  ...
  CONSTRAINT pk_cor_package PRIMARY KEY (id)
);
...
CREATE TABLE cor_partneraccount (
  ...
  CONSTRAINT pk_cor_partneraccount PRIMARY KEY (id)
);
