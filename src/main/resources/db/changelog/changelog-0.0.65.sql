...
CREATE TABLE corporatecrmsla (
  corporatecrmsla_id UUID PRIMARY KEY NOT NULL,
  id SERIAL,
...
COMMENT ON COLUMN corporatecrmsla.corporatecrmsla_id IS 'Unique identifier for corporate CRM SLA records';


DROP TABLE IF EXISTS corporatecustomer CASCADE;

CREATE TABLE corporatecustomer (
  corporatecustomer_id UUID PRIMARY KEY NOT NULL,
  corporateid SERIAL,
...
COMMENT ON COLUMN corporatecustomer.corporatecustomer_id IS 'Unique identifier for corporate customer records';
...
CREATE TABLE corporatedisbursement (
  corporatedisbursement_id UUID PRIMARY KEY NOT NULL,
  disburseid SERIAL,
...
COMMENT ON COLUMN corporatedisbursement.corporatedisbursement_id IS 'Unique identifier for corporate disbursement records';
...
CREATE TABLE corporatedisbursementclosed (
  corporatedisbursementclosed_id UUID PRIMARY KEY NOT NULL,
...
COMMENT ON COLUMN corporatedisbursementclosed.corporatedisbursementclosed_id IS 'Unique identifier for corporate disbursement closed records';
...
CREATE TABLE corporatesubfinance (
  corporatesubfinance_id UUID PRIMARY KEY NOT NULL,
  subfinanceid SERIAL,
...
COMMENT ON COLUMN corporatesubfinance.corporatesubfinance_id IS 'Unique identifier for corporate subscriber finance records';


DROP TABLE IF EXISTS corporatesubscriber_ex_rew CASCADE;

CREATE TABLE corporatesubscriber_ex_rew (
  corporatesubscriber_ex_rew_id UUID PRIMARY KEY NOT NULL,
  corid SERIAL,
  subscriberid INTEGER NOT NULL,
...
COMMENT ON COLUMN corporatesubscriber_ex_rew.corporatesubscriber_ex_rew_id IS 'Unique identifier for corporate subscriber expiry renewal records';


DROP TABLE IF EXISTS corporatesubscribers CASCADE;

CREATE TABLE corporatesubscribers (
  corporatesubscribers_id UUID PRIMARY KEY NOT NULL,
  cosubid SERIAL,
...
COMMENT ON COLUMN corporatesubscribers.corporatesubscribers_id IS 'Unique identifier for corporate subscribers records';
...
CREATE TABLE corporatesubscribers_temp (
  corporatesubscribers_temp_id UUID PRIMARY KEY NOT NULL,
...
COMMENT ON COLUMN corporatesubscribers_temp.corporatesubscribers_temp_id IS 'Unique identifier for corporate subscribers temporary records';


DROP TABLE IF EXISTS cp_cannel_partner_registration CASCADE;

CREATE TABLE cp_cannel_partner_registration (
  cp_cannel_partner_registration_id UUID PRIMARY KEY NOT NULL,
  id SERIAL,
...
COMMENT ON COLUMN cp_cannel_partner_registration.cp_cannel_partner_registration_id IS 'Unique identifier for channel partner registration records';
