...
CREATE TABLE fin_mspinvoicing (
  ...
  invoicemonth varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  designation varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  verifiedby varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  approvedate timestamp DEFAULT NULL,
  invoiceno varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  nettotal decimal(10,2) DEFAULT NULL,
  STtotal decimal(10,2) DEFAULT NULL,
  GrossTotal decimal(10,2) DEFAULT NULL,
  dot decimal(10,2) DEFAULT NULL,
