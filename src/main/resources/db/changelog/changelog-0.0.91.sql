...
CREATE TABLE issuetype (
  issuetype_id UUID DEFAULT gen_random_uuid() NOT NULL,
  slno SERIAL,
...
CREATE TABLE issuetype_backup (
  issuetype_backup_id UUID DEFAULT gen_random_uuid() NOT NULL,
  slno SERIAL,
  issuetype varchar(20) DEFAULT NULL,
  msg varchar(255) DEFAULT NULL,
  status varchar(50) NOT NULL,
...
CREATE TABLE ivr_call (
  ivr_call_id UUID DEFAULT gen_random_uuid() NOT NULL,
  id SERIAL,
...
CREATE TABLE july_adjust (
  july_adjust_id UUID DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE july_adjust2 (
  july_adjust2_id UUID DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE july_sub (
  july_sub_id UUID DEFAULT gen_random_uuid() NOT NULL,
  amt decimal(10,2) DEFAULT NULL,
...
CREATE TABLE june_agp (
  june_agp_id UUID DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE june_anp (
  june_anp_id UUID DEFAULT gen_random_uuid() NOT NULL,
  slno int NOT NULL DEFAULT 0,
  pid varchar(25) DEFAULT NULL,
  amt decimal(10,2) DEFAULT NULL,
  cause varchar(100) DEFAULT NULL,
...
CREATE TABLE ka_july (
  ka_july_id UUID DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE ka_july_sub (
  ka_july_sub_id UUID DEFAULT gen_random_uuid() NOT NULL,
