...
public class SubscriberControllerTest {
    ...
    void testFetchAllFeedbacks() throws Exception {
        ...
        mockMvc.perform(get("/api/subscriber/feedbacks"))
    ...
    void testFetchFeedbackById() throws Exception {
        ...
        mockMvc.perform(get("/api/subscriber/feedback/{id}", feedbackId))
                .andExpect(status().isOk())
    ...
    void testFetchAllOffers() throws Exception {
        ...
        mockMvc.perform(get("/api/subscriber/offers"))
                .andExpect(status().isOk())
    ...
    void testFetchOfferById() throws Exception {
        ...
        mockMvc.perform(get("/api/subscriber/offer/{id}", offerId))
                .andExpect(status().isOk())
